...
\begin{itemize}
	...
	\item Falhas de segurança conhecidas publicamente enquanto ainda estão sendo corrigidas, já que não há ocultamento das vulnerabilidades, além de outras formas de patch gap~\cite{patchGap};
